...
* Mist Location SDK iOS is distributed via framework file:            
  ...
  * latest version is 4.2.0* [[Download Link]](https://github.com/mistsys/mist-vble-ios-sdk/releases/tag/4.2.0)  
...
* and Mist Location SDK iOS also available on Swift Package Manager (SPM)
    ...
    dependencies: [
        .package(url: "https://github.com/mistsys/mist-vble-ios-sdk.git", from: "4.2.0")
    ]
