...
/**
 ...
 @param cipherSuite The SSLCipherSuite of server cert.
 @param domain The domain of serverTrust.

 @return Whether or not to trust the server.
 */
- (BOOL)evaluateServerTrust:(SecTrustRef)serverTrust cipherSuite:(SSLCipherSuite)cipherSuite forDomain:(NSString *)domain;
